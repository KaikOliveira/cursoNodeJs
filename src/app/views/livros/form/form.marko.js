...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Cadasrto de livros</h1><form action=\"/livros\" method=\"post\">");
  ...
  out.w("<div><label for=\"titulo\"> titulo: </label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"coloque o titulo\" value=\"" +
    ...
    "\"></div><div><label for=\"preco\"> preço: </label><input type=\"text\" id=\"preco\" name=\"preco\" placeholder=\"coloque o preco\" value=\"" +
